...
public class QuestEngine
{
	...
	public void onNpcLostPlayer(QuestEnv env)
	{
		Npc npc = (Npc) env.getVisibleObject();	
		for(int questId : getNpcQuestData(npc.getNpcId()).getOnLostPlayerEvent())
		{
			QuestHandler questHandler = getQuestHandlerByQuestId(questId);
			if(questHandler != null)
				questHandler.onNpcLostPlayerEvent(env);
		}
	}
	...
	public void addOnLogOut(int questId)
	{
