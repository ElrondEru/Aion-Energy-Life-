...
import com.aionemu.gameserver.configs.main.ArmsfusionConfig;
...
public class Config
{
	...
	public static void load()
	{
		try
		{
			...
			ConfigurableProcessor.process(ArmsfusionConfig.class, mainProps);
  			log.info("Loading: " + main + "/Armsfusion.properties");
