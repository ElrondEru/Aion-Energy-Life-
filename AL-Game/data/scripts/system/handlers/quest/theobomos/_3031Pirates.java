...
public class _3031Pirates extends QuestHandler
{
	...
	public void register()
	{
		...
		qe.setNpcQuestData(730144).addOnTalkEvent(questId);
		qe.setNpcQuestData(798172).addOnTalkEvent(questId);
		qe.setNpcQuestData(214219).addOnKillEvent(questId);
		qe.setNpcQuestData(214220).addOnKillEvent(questId);
		qe.setNpcQuestData(214222).addOnKillEvent(questId);
		qe.setNpcQuestData(214223).addOnKillEvent(questId);
	}
