			...
			PacketSendUtility.sendPacket(player, new SM_ABYSS_RANK_UPDATE(player));
				...
				if (rank.getRank().getId() > oldAbyssRank)
				{
					...
					{	
							...
							{
								case 14:	//
									player.getSkillList().addSkill(player, 11885, 1, true);
									player.getSkillList().addSkill(player, 11895, 1, true);
									break;
								case 15:
									player.getSkillList().removeSkill(11885);
									player.getSkillList().removeSkill(11895);
									player.getSkillList().addSkill(player, 11886, 1, true);
									player.getSkillList().addSkill(player, 11896, 1, true);
									player.getSkillList().addSkill(player, 11899, 1, true);
									break;
								case 16:
									player.getSkillList().removeSkill(11886);
									player.getSkillList().removeSkill(11896);
									player.getSkillList().removeSkill(11899);
									player.getSkillList().addSkill(player, 11887, 1, true);
									player.getSkillList().addSkill(player, 11897, 1, true);
									player.getSkillList().addSkill(player, 11899, 1, true);
									player.getSkillList().addSkill(player, 11903, 1, true);
									break;
								case 17:
									player.getSkillList().removeSkill(11887);
									player.getSkillList().removeSkill(11897);
									player.getSkillList().removeSkill(11899);
									player.getSkillList().removeSkill(11903);
									player.getSkillList().addSkill(player, 11888, 1, true);
									player.getSkillList().addSkill(player, 11898, 1, true);
									player.getSkillList().addSkill(player, 11900, 1, true);
									player.getSkillList().addSkill(player, 11903, 1, true);
									player.getSkillList().addSkill(player, 11904, 1, true);
									break;
								case 18:
									player.getSkillList().removeSkill(11888);
									player.getSkillList().removeSkill(11898);
									player.getSkillList().removeSkill(11900);
									player.getSkillList().removeSkill(11903);
									player.getSkillList().removeSkill(11904);
									player.getSkillList().addSkill(player, 11889, 1, true);
									player.getSkillList().addSkill(player, 11898, 1, true);
									player.getSkillList().addSkill(player, 11900, 1, true);
									player.getSkillList().addSkill(player, 11903, 1, true);
									player.getSkillList().addSkill(player, 11904, 1, true);
									player.getSkillList().addSkill(player, 11905, 1, true);
									player.getSkillList().addSkill(player, 11906, 1, true);
									break;
							}
					}
					else //if race == ASMODIANS
					{
						...
						{
							case 14:	//
								player.getSkillList().addSkill(player, 11890, 1, true);
								player.getSkillList().addSkill(player, 11895, 1, true);
								break;
							case 15:
								player.getSkillList().removeSkill(11890);
								player.getSkillList().removeSkill(11895);
								player.getSkillList().addSkill(player, 11891, 1, true);
								player.getSkillList().addSkill(player, 11896, 1, true);
								player.getSkillList().addSkill(player, 11901, 1, true);
								break;
							case 16:
								player.getSkillList().removeSkill(11891);
								player.getSkillList().removeSkill(11896);
								player.getSkillList().removeSkill(11901);
								player.getSkillList().addSkill(player, 11892, 1, true);
								player.getSkillList().addSkill(player, 11897, 1, true);
								player.getSkillList().addSkill(player, 11901, 1, true);
								player.getSkillList().addSkill(player, 11903, 1, true);
								break;
							case 17:
								player.getSkillList().removeSkill(11892);
								player.getSkillList().removeSkill(11897);
								player.getSkillList().removeSkill(11901);
								player.getSkillList().removeSkill(11903);
								player.getSkillList().addSkill(player, 11893, 1, true);
								player.getSkillList().addSkill(player, 11898, 1, true);
								player.getSkillList().addSkill(player, 11902, 1, true);
								player.getSkillList().addSkill(player, 11903, 1, true);
								player.getSkillList().addSkill(player, 11904, 1, true);
								break;
							case 18:
								player.getSkillList().removeSkill(11893);
								player.getSkillList().removeSkill(11898);
								player.getSkillList().removeSkill(11902);
								player.getSkillList().removeSkill(11903);
								player.getSkillList().removeSkill(11904);
								player.getSkillList().addSkill(player, 11894, 1, true);
								player.getSkillList().addSkill(player, 11898, 1, true);
								player.getSkillList().addSkill(player, 11902, 1, true);
								player.getSkillList().addSkill(player, 11903, 1, true);
								player.getSkillList().addSkill(player, 11904, 1, true);
				...
				else //abyss rank decrease, remove abyss skills
				{
					if (this.getRace().getRaceId()==0) //ELYOS
					{
						...
						{
							case 17:
								player.getSkillList().removeSkill(11889);
								player.getSkillList().removeSkill(11898);
								player.getSkillList().removeSkill(11900);
								player.getSkillList().removeSkill(11903);
								player.getSkillList().removeSkill(11904);
								player.getSkillList().removeSkill(11905);
								player.getSkillList().removeSkill(11906);
								player.getSkillList().addSkill(player, 11888, 1, true);
								player.getSkillList().addSkill(player, 11898, 1, true);
								player.getSkillList().addSkill(player, 11900, 1, true);
								player.getSkillList().addSkill(player, 11903, 1, true);
