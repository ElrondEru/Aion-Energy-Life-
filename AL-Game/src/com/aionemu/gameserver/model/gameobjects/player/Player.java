...
public class Player extends Creature
{
  ...
  /**
   ...
   if(portalCoolDowns == null || !portalCoolDowns.containsKey(worldId))
    return 0;
   return portalCoolDowns.get(worldId).getReuseTime();
    }           
    
    /**
     * @return the portalCoolDowns   
    */  
    public Map<Integer, PortalCooldown> getPortalCoolDowns()
      ...
      * * @param useDelay 
      */
      public void addPortalCoolDown(int worldId, long time, int useDelay)   
      {    
      if(portalCoolDowns == null) 
      portalCoolDowns = new FastMap<Integer, PortalCooldown>().shared();
      portalCoolDowns.put(worldId, new PortalCooldown(time, useDelay));
      }
