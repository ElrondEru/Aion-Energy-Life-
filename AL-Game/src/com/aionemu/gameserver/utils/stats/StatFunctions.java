...
public class StatFunctions
{
        ...
        public static int calculatePhysicDamageToTarget(Creature attacker, Creature target, int skillDamages)
        {
                ...
                if (attacker instanceof Player)
                {
                        ...
                        if(weaponType != null)
                        {
                                ...
                                int min = Math.round((((mainHandAttack * 100)/ average) * totalMin)/75);
				                int max = Math.round((((mainHandAttack * 100)/ average) * totalMax)/75);
        ...
        public static int calculateOffHandPhysicDamageToTarget(Creature attacker, Creature target)
        {
                ...
                int Damage = 0;
                int min = Math.round((((offHandAttack * 100)/ average) * totalMin)/75);
                int max = Math.round((((offHandAttack * 100)/ average) * totalMax)/75);
